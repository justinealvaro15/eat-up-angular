    ...
    dialogRef.afterClosed().subscribe((result: AddedShop) => {
      if (result) {
        const newShop: Shop = {
          ...
          hours: null,
          days_open: null,
          AddlTakeOutCost: result.AddlTakeOutCost,
          FreeWater: result.FreeWater,
          BYOBIncentive: result.BYOBIncentive,
          SeatingCapacity: result.BYOBIncentive,
          CLAYGO: result.CLAYGO,
          ExtraRice: result.ExtraRice,
